...
public class BasicScenario4 {
	...
	private static void modifyCustomer()
	{
		try
		{
			...
			Thread.sleep(2000);
			browser.findElement(objectmap.getLocator("modifycustomernameclick")).click();
			Thread.sleep(2000);
			browser.findElement(objectmap.getLocator("modifycustomernameclear")).clear();
			Thread.sleep(2000);
			browser.findElement(objectmap.getLocator("modifycustomernameclear")).sendKeys("cust4");
			Thread.sleep(2000);
			browser.findElement(objectmap.getLocator("modifycustomersave")).click();
			Thread.sleep(2000);
		}catch(Exception e)
		{
			e.printStackTrace();
