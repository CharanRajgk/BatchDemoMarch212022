...
public class BasicScenario6 {
	...
	private static void modifyProject()
	{
		try
		{
			...
			Thread.sleep(2000);
			browser.findElement(objectmap.getLocator("modifyprojectname")).click();
			Thread.sleep(2000);
			browser.findElement(objectmap.getLocator("modifyprojectnameclear")).clear();
			Thread.sleep(2000);
			browser.findElement(objectmap.getLocator("modifyprojectnameclear")).sendKeys("gui");
			Thread.sleep(2000);
			browser.findElement(objectmap.getLocator("modifyprojectsave")).click();
			Thread.sleep(2000);
			}catch(Exception e)
			 {
				e.printStackTrace();
